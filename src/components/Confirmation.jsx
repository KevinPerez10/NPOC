...
export default function Confirmation({open, onClose, onConfirm, message}) {
    if (!open) return null
    return (
        <div className='bg-black/70 fixed w-full h-full z-10 top-0 left-0 grid place-items-center'>
            <div className='bg-white xs:w-1/2 xs:h-1/2 w-4/5 h-1/4 rounded-lg flex flex-col gap-5 items-center justify-center p-2'>
